...
define("SITE_NAME", "Online Management System");
...
define("APP_ID", "46fe7f9a69e96e2285ad59368ee53509");
...
define("META_AUTHOR", "JGA");
define("META_DESCRIPTION", "An NDES SIP Project");
define("META_KEYWORDS", "IET,NDES");
...
define('USER_EMAIL',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['useremail'] : null ));

define('USER_ROLE',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['userrole'] : null ));