...
class UsersController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		$db->where("users.serialnumber", get_active_user('stuindex') );
		}
		if($fieldname){
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("fingerprint_id","fingerprint_select","del_fingerid","add_fingerid");
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'fingerprint_id' => 'numeric',
			);
			$this->sanitize_array = array(
				'fingerprint_id' => 'sanitize_string',
				'fingerprint_select' => 'sanitize_string',
				'del_fingerid' => 'sanitize_string',
				'add_fingerid' => 'sanitize_string',
			);
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","serialnumber","username","fingerprint_id","fingerprint_select","del_fingerid","add_fingerid");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'fingerprint_id' => 'numeric',
