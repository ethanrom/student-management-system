...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Add New Lecschedules</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="lecschedules-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("lecschedules/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-subcode"  value="<?php  echo $this->set_field_value('subcode',""); ?>" type="text" placeholder="Enter Subject Code" list="subcode_list"  required="" name="subcode"  class="form-control " />
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="input-group">
                                                        <input id="ctrl-shedtime" class="form-control datepicker  datepicker"  required="" value="<?php  echo $this->set_field_value('shedtime',time_now()); ?>" type="time" name="shedtime" placeholder="Enter Time" data-enable-time="true" data-min-date="" data-max-date=""  data-alt-format="H:i:S" data-date-format="H:i:S" data-inline="false" data-no-calendar="true" data-mode="single" /> 
                                                            <div class="input-group-append">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="input-group">
                                                            <input id="ctrl-shedendtime" class="form-control datepicker  datepicker"  required="" value="<?php  echo $this->set_field_value('shedendtime',time_now()); ?>" type="time" name="shedendtime" placeholder="Enter End Time" data-enable-time="true" data-min-date="" data-max-date=""  data-alt-format="H:i:S" data-date-format="H:i:S" data-inline="false" data-no-calendar="true" data-mode="single" /> 
                                                                <div class="input-group-append">
                                                                    <span class="input-group-text"><i class="fa fa-clock"></i></span>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-sublec"  value="<?php  echo $this->set_field_value('sublec',""); ?>" type="text" placeholder="Enter Lecturer"  required="" name="sublec"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
