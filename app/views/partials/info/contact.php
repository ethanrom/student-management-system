			...
			<div class="col-sm-7">
				<div class="panel panel-body">
					...
					<p>
						...
						<p class="adr clearfix">
							<span class="adr-group">
								...
								<span class="postal-code">Address</span><br>
								<span class="country-name">Address</span>
							</span>
						</p>
					</p>
					<hr />
					<p>
						...
						<span class="editContent"> 071-5310447</span>
					</p>
					<hr />

					<p>
						<b class="chead"><span class="material-icons">email</span> Email</b><br />
						<a href="#" class="editContent">sip2020project@gmail.com</a>
					</p>
				</div>
			</div>
		</div>
