...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Schedule a New Practicle</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="pracschedules-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("pracschedules/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-instructor"  value="<?php  echo $this->set_field_value('instructor',""); ?>" type="text" placeholder="Enter Instructor"  name="instructor"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-stugroup"  value="<?php  echo $this->set_field_value('stugroup',""); ?>" type="text" placeholder="Enter Student Group"  required="" name="stugroup"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <select required=""  id="ctrl-practicle" data-load-path="<?php print_link('api/json/pracschedules_practicle_option_list') ?>" name="practicle"  placeholder="Select the practicle ..."    class="custom-select" >
                                                                    <option value="">Select the practicle ...</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
